...
namespace DataAccessLayer.Tests.Services
{
    ...
    public class AirplaneServiceTests
    {
        ...
        {
            TestHelper.UnitOfWork.AirplaneSchema.Create(StubsObjects.AirplaneSchemaBm.ToDal());
            TestHelper.UnitOfWork.AirplaneType.Create(StubsObjects.AirplaneTypeBm.ToDal());
            TestHelper.UnitOfWork.AirplaneSubType.Create(StubsObjects.AirplaneSubTypeBm.ToDal());
            TestHelper.UnitOfWork.Airline.Create(StubsObjects.AirlineBm.ToDal()); 
        ...
        public void DeleteTest()
        {
            ...
            TestHelper.UnitOfWork.AirplaneSchema.Delete(StubsObjects.AirplaneSchemaBm.Id);
            TestHelper.UnitOfWork.AirplaneType.Delete(StubsObjects.AirplaneTypeBm.Id);
            TestHelper.UnitOfWork.AirplaneSubType.Delete(StubsObjects.AirplaneSubTypeBm.Id);
            TestHelper.UnitOfWork.Airline.Delete(StubsObjects.AirlineBm.Id);
        }
    }
}