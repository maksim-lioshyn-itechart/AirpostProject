...
namespace DataAccessLayer.Tests.Repositories
{
    ...
    {
        private readonly IBaseRepository<ClassType> _repository;

        readonly ClassType _entity = new ClassType()
        {
            Id = Guid.NewGuid(),
            Name = Guid.NewGuid().ToString(),
        };

        public ClassTypeRepositoryTests()
        {
            _repository = new ClassTypeRepository(new Test());
        }
