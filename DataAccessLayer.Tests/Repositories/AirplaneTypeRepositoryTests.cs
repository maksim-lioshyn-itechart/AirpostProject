...
namespace DataAccessLayer.Tests.Repositories
{
    ...
    {
        private readonly IBaseRepository<AirplaneType> _repository;

        readonly AirplaneType _entity = new AirplaneType()
        {
            Id = Guid.NewGuid(),
        ...
        {
            _repository = new AirplaneTypeRepository(new Test());
        }
