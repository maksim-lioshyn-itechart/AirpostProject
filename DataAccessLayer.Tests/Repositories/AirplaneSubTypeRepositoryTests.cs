...
{
    [TestFixture()]
    public class AirplaneSubTypeRepositoryTests
    {
        private readonly IBaseRepository<AirplaneSubType> _repository;

        readonly AirplaneSubType _entity = new AirplaneSubType()
        {
            Id = Guid.NewGuid(),
            Name = Guid.NewGuid().ToString(),
        };

        public AirplaneSubTypeRepositoryTests()
        {
            _repository = new AirplaneSubTypeRepository(new Test());
        }
