...
namespace DataAccessLayer.Tests.Repositories
{
    ...
    {
        private readonly IBaseRepository<DocumentType> _repository;

        readonly DocumentType _entity = new DocumentType()
        {
            Id = Guid.NewGuid(),
        ...
        {
            _repository = new DocumentTypeRepository(new Test());
        }
